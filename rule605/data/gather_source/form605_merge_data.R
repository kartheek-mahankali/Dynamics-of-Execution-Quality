...
##@Kartheek : provide order size and type as variables
# Provide order size and order type
...
#@kartheek :  form_605_mktble <- dplyr::filter(form_605_all, order_type == 11)
form_605_mktble <- dplyr::filter(form_605_all, order_type %in% ordertype)
...
#@kartheek : add this (do not change or comment above line, just add this as a new line)form_605_mktble <- dplyr::filter(form_605_mktble,  order_size ==21)
form_605_mktble <- dplyr::filter(form_605_mktble,  order_size %in% ordersize)
